...
export const DEFAULT_COMPANION_CONTROL_PLANE_URL = "https://accounts.handbot.com";
...
const FRIENDLY_MESSAGES = Object.freeze({
  ...
  network_unavailable: "HandBot could not reach its secure connection service. Check your internet and try again.",
