...
const SUBJECTS = {
  "sign-in": "Your HandBot sign-in code",
  "email-verification": "Verify your HandBot email",
  "forget-password": "Reset your HandBot password",
  "change-email": "Confirm your HandBot email change",
