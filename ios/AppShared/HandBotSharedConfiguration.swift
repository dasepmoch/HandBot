...
enum HandBotSharedConfiguration {
    static let appGroupIdentifier = "group.com.handbot.shared"
    static let legacyAppBundleIdentifier = "com.handbot.app"
    static let keychainAccessGroupInfoKey = "HandBotKeychainAccessGroup"
