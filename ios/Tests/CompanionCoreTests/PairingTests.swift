...
final class PairingTests: XCTestCase {
    ...
    func testRejectsAServiceThatDoesNotIdentifyAsHandBot() async throws {
    ...
    private static let health = Data(#"{"app":"handbot","pid":42,"static":true}"#.utf8)
