...
final class NotificationCoordinator: NSObject, UNUserNotificationCenterDelegate {
    ...
    func deliver(_ notification: NotificationFrame, sequence: Int?) {
        ...
        content.categoryIdentifier = notification.isBlocking ? "HANDBOT_APPROVAL" : "HANDBOT_UPDATE"
        ...
        let identifier = "handbot.\(notification.threadId).\(sequence.map(String.init) ?? notification.title)"
