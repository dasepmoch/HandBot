package com.handbot.companion.notifications

import android.content.Intent
import android.net.Uri
import com.handbot.companion.MainActivity
...
object NotificationIntents {
    const val ACTION_OPEN = "com.handbot.companion.OPEN_NOTIFICATION"
    ...
    fun contentIdentity(botId: String, threadId: String): String =
        "handbot://notification/${encode(botId)}/${encode(threadId)}"
