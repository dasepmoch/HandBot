...
object OnboardingCopy {
    ...
    const val UNPAIRED_HOME_BODY =
        "Pair this phone with HandBot to see your chats and respond to your bots."
    const val UNPAIRED_HOME_HINT =
        "On your computer, open HandBot → Settings → Phone."
 ...
 * [com.handbot.companion.core.NotificationOnboardingPolicy].
 */
@Composable
