...
import com.handbot.companion.notifications.notificationTarget
import com.handbot.companion.browser.CloudDesktopBrowser
import com.handbot.companion.sharing.TranscriptSharing
...
import com.handbot.companion.ui.CompanionRoot
import com.handbot.companion.ui.LocalCompanion
...
import com.handbot.companion.ui.PermissionRequests
import com.handbot.companion.ui.PendingThreadNavigation
 ...
 *
 * Connect/disconnect is not here: `HandBotApp` drives it from
 * `ProcessLifecycleOwner`, which is the Android shape of iOS's `scenePhase`.
 */
class MainActivity : ComponentActivity() {
    private val app: HandBotApp
        get() = application as HandBotApp
    ...
    private companion object {
        const val STATE_CONSUMED_NOTIFICATION = "handbot.consumedNotification"
