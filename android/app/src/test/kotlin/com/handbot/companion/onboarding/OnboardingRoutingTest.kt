...
import com.handbot.companion.core.NotificationAuthorizationState
import com.handbot.companion.core.OnboardingPairingState
...
import com.handbot.companion.ui.NotificationAccess
import com.handbot.companion.ui.notificationAuthorization
import com.handbot.companion.ui.onboardingPairingState
import com.handbot.companion.ui.OnboardingCopy
...
class OnboardingRoutingTest {
    ...
    fun `a deep link opens pairing even on a first launch nobody has answered`() {
        ...
        scene.session.receivePairingURL(
            "handbot://pair?address=127.0.0.1:8810&code=123456",
        )
        compose.waitForIdle()
