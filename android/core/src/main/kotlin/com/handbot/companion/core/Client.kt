...
class PairingRouteError(val attemptedRoutes: List<String>) : IOException(
    "Couldn't reach this computer through any available route " +
        "(${attemptedRoutes.joinToString()}). Keep Phone access turned on in HandBot, then try again.",
)

internal const val SCOPED_IPV6_HTTP_HOST = "scoped-ipv6.handbot.invalid"
