...
export const BOT_PACKAGE_FORMAT = "handbot.package" as const;
...
const packageSchema = z.object({
  format: z.literal(BOT_PACKAGE_FORMAT, { error: "This is not an HandBot package" }),
 ...
 * run without HandBot or another proprietary parser. */
