...
export const TEAM_LIBRARY_REPOSITORY = "https://github.com/dasepmoch/handbot-teams";
export const TEAM_LIBRARY_RAW_ROOT = "https://raw.githubusercontent.com/dasepmoch/handbot-teams/main";
...
export function parseTeamCatalog(value: unknown): TeamCatalog {
  if (!isRecord(value) || value.format !== "handbot.catalog" || value.version !== 1) {
